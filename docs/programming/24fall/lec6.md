...
!!! example "例1.6.1"
    ...
    <img class="center-picture" src="../lec6.assets/pic2.png" width="100%">
    **Answer:**
    A
...
!!! example "例1.6.5"
    ...
    **Answer:**
    ...
    <img class="center-picture" src="../lec6.assets/pic6.png" width="100%">
...
<img class="center-picture" src="../lec6.assets/pic5.png" width="90%">

同样的，使用数组或者链表都可以实现队列。

!!! example "例2.5.2.1"

    <img class="center-picture" src="../lec6.assets/pic7.png" width="90%">
